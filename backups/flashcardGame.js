...
import { View, TouchableOpacity, Text, Image, ActivityIndicator, Alert, Animated, Dimensions, Platform } from 'react-native';
...
import { generateFlashcards, loadFlashcards, loadAudioMapping } from '../utils/flashcardUtils';
import { 
  initAudio, 
  playAudio, 
  createTestAudioFile,
